...
import { CheckCircle, Package, Mail, Coffee, MapPin, FileText } from 'lucide-react';

const BACKEND_URL = process.env.REACT_APP_BACKEND_URL;

function MuggsSuccess() {
  ...
  const checkPaymentStatus = async (sessionId) => {
    try {
      const response = await axios.get(`${BACKEND_URL}/api/muggs/checkout/status/${sessionId}`);
    ...
    <div className="substack-site">
      ...
      <header className="substack-header">
        ...
        <nav className="header-nav">
          ...
          <Link to="/shop/muggs" className="nav-item">B.B. Muggs</Link>
          ...
          <div className="success-content" style={{ textAlign: 'center', maxWidth: '700px', width: '100%' }}>
              ...
              <div className="order-item">
                ...
                <div className="order-item-details">
                  ...
                  {orderData.variant_label && (
                    <p className="item-specs">{orderData.variant_label}</p>
                  )}
            ...
            <div className="order-info-cards">
              ...
              <div className="info-card">
                <Package size={32} />
                <h3>Shipping</h3>
                <p>Your order will be carefully prepared and shipped within 5-7 business days.</p>
              </div>
            </div>

            <div className="success-actions">
              <Link to="/shop/muggs" className="btn-primary" data-testid="continue-shopping-btn">
                Continue Shopping
              </Link>
